...
flowchart TD
    ...
    N1_Dario --> N2_Luis["Luis Christian Huacasi<br/>Frontend Developer (Android)<br/>Implementa la app nativa en Kotlin"]
...
flowchart TD
    ...
    subgraph Cadena Operativa
        ...
        N1_Dario --> N2_Luis["Luis Christian Huacasi<br/>Integra Material 3 y la API de rutas"]
...
flowchart TD
    ...
    N1_Dario --> N2_Luis["Luis Christian Huacasi<br/>Desarrolla la experiencia Android"]
